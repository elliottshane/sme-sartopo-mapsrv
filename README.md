...
I am working on this woorking with sartopo.com.  From what I understand, I need to send the same info from above with:
...
to the appropriate data and run, you get a hash.  This hash should match the hash generated by the javascript as well.  I have not implemented a way for the mapserver to post to sartopo.com yet as I cannot get them to work.  for now, the following is implemented:
